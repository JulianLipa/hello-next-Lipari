    ...
    <main className={"main"}>
      ...
      <div className={'mainScreen'}>
        ...
        <div className={'play-section'}>
          <Image src="/images/icons/play.svg" width={iconSize*2} height={iconSize*2} alt="play icon" className={playClasses}/>
          <Image src="/images/icons/shuffle.svg" width={iconSize} height={iconSize} alt="shuffle icon" className={playClasses}/>
          <h2>Seguir</h2>
          <Image src="/images/icons/more.svg" width={iconSize*1.2} height={iconSize*1.2} alt="more icon" className={playClasses}/>
        </div>

        <div className={'popular-section'}>
          <h2>Popular</h2>
          {songs.map((song, index) => (
            <Single key={index} num={popularAux++} title={song.title} img={song.img} long={song.duration} views={song.views}/>
          ))}
        </div>
        ...
        <div className={'popular-section'}>
          ...
          <div className={'albums-section'}>
            {albums.map((album, index) => (
              <Albums key={index} title={album.title} img={album.img} year={album.year} long={album.long}/>
            ))}
          </div>
        </div>
        </div>
